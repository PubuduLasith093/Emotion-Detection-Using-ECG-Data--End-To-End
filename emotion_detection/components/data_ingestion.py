...
from emotion_detection.data_access.emotion_detection import EmotionDetection
...
class DataIngestion:
    ...
    def export_data_into_feature_store(self)->DataFrame:
        ...
        try:
            ...
            dataframe = emotion_detection.export_mat_file_as_dataframe()
    ...
    def initiate_data_ingestion(self) ->DataIngestionArtifact:
        ...
        try:
            ...
            logging.info("Got the data from local folder")
